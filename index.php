...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	...
	<head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDGGI9j2_j7SCd25rBBNsQTst11FCRKYqc"></script>
	...
	<body class="smoothscroll enable-animation">
		<div id="wrapper">
			...
			<?php
                ...
                include 'my_main_slider.php';
                include 'comp_2col_blog_1row.php';
                include 'comp_3col_blog_1row.php';
                include 'my_slider_4posts.php';
