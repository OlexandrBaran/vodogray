...
<div id="wrapper">
    ...
    include 'comp_video_fullscreen.php';
    echo '<div class="row">
            <br/><h1 style="position: absolute;
                margin-left: auto;
                margin-right: auto;
                left: 0;
                right: 0;
    ...
    include 'my_onepage_redirect.php';
    include 'my_blog_single_fullwidth_content.php';
